...
// SWPrecacheWebpackPlugin removed: the generated /service-worker.js was
// shipped but never registered anywhere in the app, and on top of that the
// precache strategy meant any future SW registration would pin clients to a
// stale bundle. Removing it eliminates an unused 4 KB asset and a deploy-
// freshness footgun.
...
module.exports = {
  ...
  plugins: [
    ...
    // Minify the code (uglify-es via uglifyjs-webpack-plugin@1 — handles ES2015+ deps like @motionone)
    ...
    // (sw-precache plugin intentionally removed — see comment at top.)
